                ...
                <div class="card__content--header">
                    <div>
                        ...
                        <select name="" id="" class="input" v-model="form.customer_id">
                            ...
                            <option :value="customers.id" v-for="customers in allCustomer" :key="customers.id">{{
                                customers.firstname }}</option>
                        </select>
                    </div>
                    <div>
                        <p class="my-1">Date</p>
                ...
                <div class="table">
                    ...
                    <div class="table--items2" v-for="(itemcart, i) in form.invoice_items" :key="itemcart.id">
                        ...
                        <p style="color: red; font-size: 24px;cursor: pointer;"
                            @click="deteleinvoiceItem(itemcart.id, i)">
                            &times;
                        </p>
                    </div>
